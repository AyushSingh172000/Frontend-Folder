...
// Object.fromEntries is used to covert the array to object form
...
const obj1={
 ...
 const {name, age, country:{city, state}, isWorking}=obj1
 console.log(name);
 console.log(age);
 console.log(city);
 console.log(state);
